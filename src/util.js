/**
 * Functions copied from https://gerrit.wikimedia.org/r/plugins/gitiles/mediawiki/core/+/master/resources/src/mediawiki.util/util.js 
...
module.exports = function() {
	...
	class Util {
		 ...
		 * @return {boolean}
		 */
		static isIPAddress( address, allowBlock ) {
		 ...
		 * @return {boolean}
		 */
		static isIPv4Address( address, allowBlock ) {
			var block,
		 ...
		 * @return {boolean}
		 */
		static isIPv6Address( address, allowBlock ) {
